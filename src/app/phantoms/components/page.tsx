...
import { UploadIcon, VideosIcon, DotsVerticalIcon, PencilIcon, AddIcon } from '../../../../public/assets/Icons';

import useCameraService from '@/app/cameras/hooks/useCameraService';
import WebCamSettingsActiveComponent from './components/trainingScripts/classification/reactFlowCardNodes/collectDataNode/webCamActiveComponent/WebCamSettingsActiveComponent';
import CollectDataUsingWebcam from './components/trainingScripts/classification/reactFlowCardNodes/collectDataNode/webCamActiveComponent/CollectDataUsingWebcam';
import CardHeaderComponent from './components/trainingScripts/classification/reactFlowCardNodes/collectDataNode/cardHeaderComponent/CardHeaderComponent';
import TrainingNodeForm from './components/trainingScripts/classification/reactFlowCardNodes/adjustTrainSettingsNode/TrainingNodeForm';
