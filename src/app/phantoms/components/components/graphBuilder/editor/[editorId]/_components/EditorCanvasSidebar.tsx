...
'use client'
import { EditorNodeSpecificTypes, EditorNodeType, EditorNodeTypes } from '@/app/phantoms/components/types/EditorCanvasTypes'
import { useEditor } from '@/providers/editor-provider'
import { Tabs, TabsContent, TabsList, TabsTrigger } from '@/components/ui/tabs'
import { onDragStart } from '@/app/phantoms/components/utils/editor-utils'
...
const EditorCanvasSidebar = ({ nodes }: Props) => {
  ...
  const [datatype, setDatatype] = useState(selectedHandle?.datatype || 'str');
  ...
  const renderExternalConfig = (type: EditorNodeSpecificTypes) => {
    switch (type) {
      ...
      case 'Condition':
        return <div>Condition-specific settings go here...</div>
      default:
