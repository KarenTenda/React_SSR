...
import { EditorCanvasCardType, EditorNodeType } from '@/app/phantoms/components/types/EditorCanvasTypes';
import { HandleInfo, NodeMetadata } from '@/app/phantoms/components/types/PinMetadataTypes';
import { useEditor } from '@/providers/editor-provider';
import { EditorCanvasDefaultCardTypes } from '@/app/phantoms/components/constants/EditorCanvasDefaultCardTypes';
...
import { EditorCanvasDefaultHandleData } from '@/app/phantoms/components/constants/EditorCanvasDefaultPinData';
...
const GraphBuilderEditor = () => {
    ...
    const onConnect = useCallback((params: Edge | Connection) => {
        ...
        if (sourceHandleData) {
            // Propagate the data to the target node
