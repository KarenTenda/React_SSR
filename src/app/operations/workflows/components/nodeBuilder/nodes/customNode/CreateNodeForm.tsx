...
const CreateNodeForm = () => {
  ...
  const onSubmit = (data: NodeFormData) => {
    ...
    const queryUrl = `/operations/workflows/components/nodeBuilder/nodes/customNode/write-code?inputs=${encodeURIComponent(inputs)}&outputs=${encodeURIComponent(outputs)}&pins=${encodeURIComponent(pinsJson)}`;
